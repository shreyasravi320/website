...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_myWasmFunction')) {
        Object.defineProperty(Module['ready'], '_myWasmFunction', { configurable: true, get: function() { abort('You are getting _myWasmFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_myWasmFunction', { configurable: true, set: function() { abort('You are setting _myWasmFunction on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _myWasmFunction = Module["_myWasmFunction"] = createExportWrapper("myWasmFunction");
