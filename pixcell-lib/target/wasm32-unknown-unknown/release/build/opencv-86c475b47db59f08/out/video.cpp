...
extern "C" {
	...
	void cv_KalmanFilter_propStatePre_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propStatePost_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propTransitionMatrix_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propControlMatrix_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propMeasurementMatrix_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propProcessNoiseCov_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propMeasurementNoiseCov_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propErrorCovPre_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propGain_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
			instance->gain = *val;
	}
	...
	void cv_KalmanFilter_propErrorCovPost_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
	...
	void cv_KalmanFilter_propTemp1_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
			instance->temp1 = *val;
	}
	...
	void cv_KalmanFilter_propTemp2_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
			instance->temp2 = *val;
	}
	...
	void cv_KalmanFilter_propTemp3_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
			instance->temp3 = *val;
	}
	...
	void cv_KalmanFilter_propTemp4_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
			instance->temp4 = *val;
	}
	...
	void cv_KalmanFilter_propTemp5_Mat(cv::KalmanFilter* instance, cv::Mat* val) {
			instance->temp5 = *val;
	}
	...
	void cv_TrackerDaSiamRPN_Params_propModel_string(cv::TrackerDaSiamRPN::Params* instance, char* val) {
	...
	void cv_TrackerDaSiamRPN_Params_propKernel_cls1_string(cv::TrackerDaSiamRPN::Params* instance, char* val) {
	...
	void cv_TrackerDaSiamRPN_Params_propKernel_r1_string(cv::TrackerDaSiamRPN::Params* instance, char* val) {
	...
	void cv_TrackerDaSiamRPN_Params_propBackend_int(cv::TrackerDaSiamRPN::Params* instance, int val) {
	...
	void cv_TrackerDaSiamRPN_Params_propTarget_int(cv::TrackerDaSiamRPN::Params* instance, int val) {
			instance->target = val;
	}
	...
	void cv_TrackerGOTURN_Params_propModelTxt_string(cv::TrackerGOTURN::Params* instance, char* val) {
	...
	void cv_TrackerGOTURN_Params_propModelBin_string(cv::TrackerGOTURN::Params* instance, char* val) {
	...
	void cv_TrackerNano_create_const_ParamsR(const cv::TrackerNano::Params* parameters, Result<cv::Ptr<cv::TrackerNano>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::TrackerNano>*>, ocvrs_return);
	}
	...
	void cv_TrackerNano_Params_Params(Result<cv::TrackerNano::Params*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::TrackerNano::Params*>, ocvrs_return);
	}
	...
	void cv_TrackerNano_Params_propBackbone_string(cv::TrackerNano::Params* instance, char* val) {
	...
	void cv_TrackerNano_Params_propNeckhead_string(cv::TrackerNano::Params* instance, char* val) {
	...
	void cv_TrackerNano_Params_propBackend_int(cv::TrackerNano::Params* instance, int val) {
			instance->backend = val;
	}
	...
	void cv_TrackerNano_Params_propTarget_int(cv::TrackerNano::Params* instance, int val) {
			instance->target = val;
	}
