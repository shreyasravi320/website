...
extern "C" {
	...
	void cv_ppf_match_3d_Pose3D_propAlpha_double(cv::ppf_match_3d::Pose3D* instance, double val) {
			instance->alpha = val;
	}
	...
	void cv_ppf_match_3d_Pose3D_propResidual_double(cv::ppf_match_3d::Pose3D* instance, double val) {
	...
	void cv_ppf_match_3d_Pose3D_propModelIndex_size_t(cv::ppf_match_3d::Pose3D* instance, size_t val) {
	...
	void cv_ppf_match_3d_Pose3D_propNumVotes_size_t(cv::ppf_match_3d::Pose3D* instance, size_t val) {
	...
	void cv_ppf_match_3d_Pose3D_propPose_Matx44d(cv::ppf_match_3d::Pose3D* instance, cv::Matx44d* val) {
			instance->pose = *val;
	}
	...
	void cv_ppf_match_3d_Pose3D_propAngle_double(cv::ppf_match_3d::Pose3D* instance, double val) {
			instance->angle = val;
	}
	...
	void cv_ppf_match_3d_Pose3D_propT_Vec3d(cv::ppf_match_3d::Pose3D* instance, cv::Vec3d* val) {
			instance->t = *val;
	}
	...
	void cv_ppf_match_3d_Pose3D_propQ_Vec4d(cv::ppf_match_3d::Pose3D* instance, cv::Vec4d* val) {
			instance->q = *val;
	}
	...
	void cv_ppf_match_3d_PoseCluster3D_propPoseList_vectorLPose3DPtrG(cv::ppf_match_3d::PoseCluster3D* instance, std::vector<cv::ppf_match_3d::Pose3DPtr>* val) {
	...
	void cv_ppf_match_3d_PoseCluster3D_propNumVotes_size_t(cv::ppf_match_3d::PoseCluster3D* instance, size_t val) {
			instance->numVotes = val;
	}
	...
	void cv_ppf_match_3d_PoseCluster3D_propId_int(cv::ppf_match_3d::PoseCluster3D* instance, int val) {
			instance->id = val;
	}
