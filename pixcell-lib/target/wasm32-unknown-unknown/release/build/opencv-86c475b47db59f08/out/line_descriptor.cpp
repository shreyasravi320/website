...
extern "C" {
	...
	void cv_line_descriptor_BinaryDescriptor_Params_propNumOfOctave__int(cv::line_descriptor::BinaryDescriptor::Params* instance, int val) {
	...
	void cv_line_descriptor_BinaryDescriptor_Params_propWidthOfBand__int(cv::line_descriptor::BinaryDescriptor::Params* instance, int val) {
	...
	void cv_line_descriptor_BinaryDescriptor_Params_propReductionRatio_int(cv::line_descriptor::BinaryDescriptor::Params* instance, int val) {
	...
	void cv_line_descriptor_BinaryDescriptor_Params_propKsize__int(cv::line_descriptor::BinaryDescriptor::Params* instance, int val) {
			instance->ksize_ = val;
	}
