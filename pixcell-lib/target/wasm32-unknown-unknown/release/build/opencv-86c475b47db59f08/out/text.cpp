...
extern "C" {
	...
	void cv_text_ERStat_propPixel_int(cv::text::ERStat* instance, int val) {
			instance->pixel = val;
	}
	...
	void cv_text_ERStat_propLevel_int(cv::text::ERStat* instance, int val) {
			instance->level = val;
	}
	...
	void cv_text_ERStat_propArea_int(cv::text::ERStat* instance, int val) {
			instance->area = val;
	}
	...
	void cv_text_ERStat_propPerimeter_int(cv::text::ERStat* instance, int val) {
	...
	void cv_text_ERStat_propEuler_int(cv::text::ERStat* instance, int val) {
			instance->euler = val;
	}
	...
	void cv_text_ERStat_propRect_Rect(cv::text::ERStat* instance, cv::Rect* val) {
			instance->rect = *val;
	}
	...
	void cv_text_ERStat_propMed_crossings_float(cv::text::ERStat* instance, float val) {
	...
	void cv_text_ERStat_propHole_area_ratio_float(cv::text::ERStat* instance, float val) {
	...
	void cv_text_ERStat_propConvex_hull_ratio_float(cv::text::ERStat* instance, float val) {
	...
	void cv_text_ERStat_propNum_inflexion_points_float(cv::text::ERStat* instance, float val) {
	...
	void cv_text_ERStat_propProbability_double(cv::text::ERStat* instance, double val) {
	...
	void cv_text_ERStat_propParent_ERStatX(cv::text::ERStat* instance, cv::text::ERStat* val) {
			instance->parent = val;
	}
	...
	void cv_text_ERStat_propChild_ERStatX(cv::text::ERStat* instance, cv::text::ERStat* val) {
			instance->child = val;
	}
	...
	void cv_text_ERStat_propNext_ERStatX(cv::text::ERStat* instance, cv::text::ERStat* val) {
			instance->next = val;
	}
	...
	void cv_text_ERStat_propPrev_ERStatX(cv::text::ERStat* instance, cv::text::ERStat* val) {
			instance->prev = val;
	}
	...
	void cv_text_ERStat_propLocal_maxima_bool(cv::text::ERStat* instance, bool val) {
	...
	void cv_text_ERStat_propMax_probability_ancestor_ERStatX(cv::text::ERStat* instance, cv::text::ERStat* val) {
	...
	void cv_text_ERStat_propMin_probability_ancestor_ERStatX(cv::text::ERStat* instance, cv::text::ERStat* val) {
