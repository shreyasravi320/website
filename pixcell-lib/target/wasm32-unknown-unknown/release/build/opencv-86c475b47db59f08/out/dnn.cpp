...
extern "C" {
	void cv_dnn_NMSBoxesBatched_const_vectorLRect2dGR_const_vectorLfloatGR_const_vectorLintGR_const_float_const_float_vectorLintGR_const_float_const_int(const std::vector<cv::Rect2d>* bboxes, const std::vector<float>* scores, const std::vector<int>* class_ids, const float score_threshold, const float nms_threshold, std::vector<int>* indices, const float eta, const int top_k, Result_void* ocvrs_return) {
		try {
	...
	void cv_dnn_NMSBoxesBatched_const_vectorLRectGR_const_vectorLfloatGR_const_vectorLintGR_const_float_const_float_vectorLintGR_const_float_const_int(const std::vector<cv::Rect>* bboxes, const std::vector<float>* scores, const std::vector<int>* class_ids, const float score_threshold, const float nms_threshold, std::vector<int>* indices, const float eta, const int top_k, Result_void* ocvrs_return) {
		try {
			cv::dnn::NMSBoxesBatched(*bboxes, *scores, *class_ids, score_threshold, nms_threshold, *indices, eta, top_k);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_dnn_blobFromImageWithParams_const__InputArrayR_const__OutputArrayR_const_Image2BlobParamsR(const cv::_InputArray* image, const cv::_OutputArray* blob, const cv::dnn::Image2BlobParams* param, Result_void* ocvrs_return) {
		try {
	...
	void cv_dnn_blobFromImagesWithParams_const__InputArrayR_const__OutputArrayR_const_Image2BlobParamsR(const cv::_InputArray* images, const cv::_OutputArray* blob, const cv::dnn::Image2BlobParams* param, Result_void* ocvrs_return) {
		try {
	...
	void cv_dnn_BackendNode_propBackendId_int(cv::dnn::BackendNode* instance, int val) {
	...
	void cv_dnn_BackendWrapper_propBackendId_int(cv::dnn::BackendWrapper* instance, int val) {
			instance->backendId = val;
	}
	...
	void cv_dnn_BackendWrapper_propTargetId_int(cv::dnn::BackendWrapper* instance, int val) {
	...
	void cv_dnn_BaseConvolutionLayer_propKernel_Size(cv::dnn::BaseConvolutionLayer* instance, cv::Size* val) {
			instance->kernel = *val;
	}
	...
	void cv_dnn_BaseConvolutionLayer_propStride_Size(cv::dnn::BaseConvolutionLayer* instance, cv::Size* val) {
			instance->stride = *val;
	}
	...
	void cv_dnn_BaseConvolutionLayer_propPad_Size(cv::dnn::BaseConvolutionLayer* instance, cv::Size* val) {
			instance->pad = *val;
	}
	...
	void cv_dnn_BaseConvolutionLayer_propDilation_Size(cv::dnn::BaseConvolutionLayer* instance, cv::Size* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propAdjustPad_Size(cv::dnn::BaseConvolutionLayer* instance, cv::Size* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propAdjust_pads_vectorLsize_tG(cv::dnn::BaseConvolutionLayer* instance, std::vector<size_t>* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propKernel_size_vectorLsize_tG(cv::dnn::BaseConvolutionLayer* instance, std::vector<size_t>* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propStrides_vectorLsize_tG(cv::dnn::BaseConvolutionLayer* instance, std::vector<size_t>* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propDilations_vectorLsize_tG(cv::dnn::BaseConvolutionLayer* instance, std::vector<size_t>* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propPads_begin_vectorLsize_tG(cv::dnn::BaseConvolutionLayer* instance, std::vector<size_t>* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propPads_end_vectorLsize_tG(cv::dnn::BaseConvolutionLayer* instance, std::vector<size_t>* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propPadMode_String(cv::dnn::BaseConvolutionLayer* instance, char* val) {
	...
	void cv_dnn_BaseConvolutionLayer_propNumOutput_int(cv::dnn::BaseConvolutionLayer* instance, int val) {
	...
	void cv_dnn_BatchNormLayer_propHasWeights_bool(cv::dnn::BatchNormLayer* instance, bool val) {
	...
	void cv_dnn_BatchNormLayer_propHasBias_bool(cv::dnn::BatchNormLayer* instance, bool val) {
	...
	void cv_dnn_BatchNormLayer_propEpsilon_float(cv::dnn::BatchNormLayer* instance, float val) {
	...
	void cv_dnn_BatchNormLayerInt8_propInput_sc_float(cv::dnn::BatchNormLayerInt8* instance, float val) {
	...
	void cv_dnn_BatchNormLayerInt8_propOutput_sc_float(cv::dnn::BatchNormLayerInt8* instance, float val) {
	...
	void cv_dnn_BatchNormLayerInt8_propInput_zp_int(cv::dnn::BatchNormLayerInt8* instance, int val) {
	...
	void cv_dnn_BatchNormLayerInt8_propOutput_zp_int(cv::dnn::BatchNormLayerInt8* instance, int val) {
	...
	void cv_dnn_CeluLayer_propAlpha_float(cv::dnn::CeluLayer* instance, float val) {
			instance->alpha = val;
	}
	...
	void cv_dnn_ConcatLayer_propAxis_int(cv::dnn::ConcatLayer* instance, int val) {
			instance->axis = val;
	}
	...
	void cv_dnn_ConcatLayer_propPadding_bool(cv::dnn::ConcatLayer* instance, bool val) {
	...
	void cv_dnn_ConcatLayer_propPaddingValue_int(cv::dnn::ConcatLayer* instance, int val) {
	...
	void cv_dnn_ConvolutionLayer_propFusedActivation_bool(cv::dnn::ConvolutionLayer* instance, bool val) {
	...
	void cv_dnn_ConvolutionLayer_propFusedAdd_bool(cv::dnn::ConvolutionLayer* instance, bool val) {
	...
	void cv_dnn_ConvolutionLayer_propUseWinograd_bool(cv::dnn::ConvolutionLayer* instance, bool val) {
	...
	void cv_dnn_ConvolutionLayerInt8_propInput_zp_int(cv::dnn::ConvolutionLayerInt8* instance, int val) {
			instance->input_zp = val;
	}
	...
	void cv_dnn_ConvolutionLayerInt8_propOutput_zp_int(cv::dnn::ConvolutionLayerInt8* instance, int val) {
			instance->output_zp = val;
	}
	...
	void cv_dnn_ConvolutionLayerInt8_propInput_sc_float(cv::dnn::ConvolutionLayerInt8* instance, float val) {
			instance->input_sc = val;
	}
	...
	void cv_dnn_ConvolutionLayerInt8_propOutput_sc_float(cv::dnn::ConvolutionLayerInt8* instance, float val) {
			instance->output_sc = val;
	}
	...
	void cv_dnn_ConvolutionLayerInt8_propPer_channel_bool(cv::dnn::ConvolutionLayerInt8* instance, bool val) {
	...
	void cv_dnn_ConvolutionLayerInt8_propUseWinograd_bool(cv::dnn::ConvolutionLayerInt8* instance, bool val) {
			instance->useWinograd = val;
	}
	...
	void cv_dnn_CumSumLayer_propExclusive_int(cv::dnn::CumSumLayer* instance, int val) {
	...
	void cv_dnn_CumSumLayer_propReverse_int(cv::dnn::CumSumLayer* instance, int val) {
	...
	void cv_dnn_DequantizeLayer_propScales_vectorLfloatG(cv::dnn::DequantizeLayer* instance, std::vector<float>* val) {
			instance->scales = *val;
	}
	...
	void cv_dnn_DequantizeLayer_propZeropoints_vectorLintG(cv::dnn::DequantizeLayer* instance, std::vector<int>* val) {
	...
	void cv_dnn_ELULayer_propAlpha_float(cv::dnn::ELULayer* instance, float val) {
			instance->alpha = val;
	}
	...
	void cv_dnn_ExpLayer_propBase_float(cv::dnn::ExpLayer* instance, float val) {
			instance->base = val;
	}
	...
	void cv_dnn_ExpLayer_propScale_float(cv::dnn::ExpLayer* instance, float val) {
			instance->scale = val;
	}
	...
	void cv_dnn_ExpLayer_propShift_float(cv::dnn::ExpLayer* instance, float val) {
			instance->shift = val;
	}
	...
	void cv_dnn_GatherLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::GatherLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::GatherLayer>*>, ocvrs_return);
	}
	...
	void cv_dnn_GeluApproximationLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::GeluApproximationLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::GeluApproximationLayer>*>, ocvrs_return);
	}
	...
	void cv_dnn_GeluLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::GeluLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::GeluLayer>*>, ocvrs_return);
	}
	...
	void cv_dnn_HardSigmoidLayer_propAlpha_float(cv::dnn::HardSigmoidLayer* instance, float val) {
			instance->alpha = val;
	}
	...
	void cv_dnn_HardSigmoidLayer_propBeta_float(cv::dnn::HardSigmoidLayer* instance, float val) {
			instance->beta = val;
	}
	...
	void cv_dnn_Image2BlobParams_Image2BlobParams(Result<cv::dnn::Image2BlobParams>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::dnn::Image2BlobParams>, ocvrs_return);
	}
	...
	void cv_dnn_InnerProductLayer_propAxis_int(cv::dnn::InnerProductLayer* instance, int val) {
			instance->axis = val;
	}
	...
	void cv_dnn_InnerProductLayerInt8_propInput_zp_int(cv::dnn::InnerProductLayerInt8* instance, int val) {
			instance->input_zp = val;
	}
	...
	void cv_dnn_InnerProductLayerInt8_propOutput_zp_int(cv::dnn::InnerProductLayerInt8* instance, int val) {
			instance->output_zp = val;
	}
	...
	void cv_dnn_InnerProductLayerInt8_propInput_sc_float(cv::dnn::InnerProductLayerInt8* instance, float val) {
			instance->input_sc = val;
	}
	...
	void cv_dnn_InnerProductLayerInt8_propOutput_sc_float(cv::dnn::InnerProductLayerInt8* instance, float val) {
			instance->output_sc = val;
	}
	...
	void cv_dnn_InnerProductLayerInt8_propPer_channel_bool(cv::dnn::InnerProductLayerInt8* instance, bool val) {
			instance->per_channel = val;
	}
	...
	void cv_dnn_LRNLayer_propType_int(cv::dnn::LRNLayer* instance, int val) {
			instance->type = val;
	}
	...
	void cv_dnn_LRNLayer_propSize_int(cv::dnn::LRNLayer* instance, int val) {
			instance->size = val;
	}
	...
	void cv_dnn_LRNLayer_propAlpha_float(cv::dnn::LRNLayer* instance, float val) {
			instance->alpha = val;
	}
	...
	void cv_dnn_LRNLayer_propBeta_float(cv::dnn::LRNLayer* instance, float val) {
			instance->beta = val;
	}
	...
	void cv_dnn_LRNLayer_propBias_float(cv::dnn::LRNLayer* instance, float val) {
			instance->bias = val;
	}
	...
	void cv_dnn_LRNLayer_propNormBySize_bool(cv::dnn::LRNLayer* instance, bool val) {
	...
	void cv_dnn_Layer_propBlobs_vectorLMatG(cv::dnn::Layer* instance, std::vector<cv::Mat>* val) {
			instance->blobs = *val;
	}
	...
	void cv_dnn_Layer_propName_String(cv::dnn::Layer* instance, char* val) {
	...
	void cv_dnn_Layer_propType_String(cv::dnn::Layer* instance, char* val) {
	...
	void cv_dnn_Layer_propPreferableTarget_int(cv::dnn::Layer* instance, int val) {
	...
	void cv_dnn_LayerNormLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::LayerNormLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::LayerNormLayer>*>, ocvrs_return);
	}
	...
	void cv_dnn_LayerNormLayer_propHasBias_bool(cv::dnn::LayerNormLayer* instance, bool val) {
			instance->hasBias = val;
	}
	...
	void cv_dnn_LayerNormLayer_propAxis_int(cv::dnn::LayerNormLayer* instance, int val) {
			instance->axis = val;
	}
	...
	void cv_dnn_LayerNormLayer_propEpsilon_float(cv::dnn::LayerNormLayer* instance, float val) {
			instance->epsilon = val;
	}
	...
	void cv_dnn_LayerParams_new_const(Result<cv::dnn::LayerParams*>* ocvrs_return) {
		try {
			cv::dnn::LayerParams* ret = new cv::dnn::LayerParams();
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::dnn::LayerParams*>, ocvrs_return);
	}
	...
	void cv_dnn_LayerParams_propBlobs_vectorLMatG(cv::dnn::LayerParams* instance, std::vector<cv::Mat>* val) {
			instance->blobs = *val;
	}
	...
	void cv_dnn_LayerParams_propName_String(cv::dnn::LayerParams* instance, char* val) {
			instance->name = std::string(val);
	}
	...
	void cv_dnn_LayerParams_propType_String(cv::dnn::LayerParams* instance, char* val) {
			instance->type = std::string(val);
	}
	...
	void cv_dnn_MVNLayer_propEps_float(cv::dnn::MVNLayer* instance, float val) {
			instance->eps = val;
	}
	...
	void cv_dnn_MVNLayer_propNormVariance_bool(cv::dnn::MVNLayer* instance, bool val) {
	...
	void cv_dnn_MVNLayer_propAcrossChannels_bool(cv::dnn::MVNLayer* instance, bool val) {
	...
	void cv_dnn_MaxUnpoolLayer_propPoolKernel_Size(cv::dnn::MaxUnpoolLayer* instance, cv::Size* val) {
	...
	void cv_dnn_MaxUnpoolLayer_propPoolPad_Size(cv::dnn::MaxUnpoolLayer* instance, cv::Size* val) {
	...
	void cv_dnn_MaxUnpoolLayer_propPoolStride_Size(cv::dnn::MaxUnpoolLayer* instance, cv::Size* val) {
	...
	void cv_dnn_NaryEltwiseLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::NaryEltwiseLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::NaryEltwiseLayer>*>, ocvrs_return);
	}
	...
	void cv_dnn_Net_enableWinograd_bool(cv::dnn::Net* instance, bool useWinograd, Result_void* ocvrs_return) {
		try {
	...
	void cv_dnn_NormalizeBBoxLayer_propPnorm_float(cv::dnn::NormalizeBBoxLayer* instance, float val) {
			instance->pnorm = val;
	}
	...
	void cv_dnn_NormalizeBBoxLayer_propEpsilon_float(cv::dnn::NormalizeBBoxLayer* instance, float val) {
			instance->epsilon = val;
	}
	...
	void cv_dnn_NormalizeBBoxLayer_propAcrossSpatial_bool(cv::dnn::NormalizeBBoxLayer* instance, bool val) {
	...
	void cv_dnn_PoolingLayer_propType_int(cv::dnn::PoolingLayer* instance, int val) {
			instance->type = val;
	}
	...
	void cv_dnn_PoolingLayer_propKernel_size_vectorLsize_tG(cv::dnn::PoolingLayer* instance, std::vector<size_t>* val) {
			instance->kernel_size = *val;
	}
	...
	void cv_dnn_PoolingLayer_propStrides_vectorLsize_tG(cv::dnn::PoolingLayer* instance, std::vector<size_t>* val) {
			instance->strides = *val;
	}
	...
	void cv_dnn_PoolingLayer_propPads_begin_vectorLsize_tG(cv::dnn::PoolingLayer* instance, std::vector<size_t>* val) {
			instance->pads_begin = *val;
	}
	...
	void cv_dnn_PoolingLayer_propPads_end_vectorLsize_tG(cv::dnn::PoolingLayer* instance, std::vector<size_t>* val) {
			instance->pads_end = *val;
	}
	...
	void cv_dnn_PoolingLayer_propGlobalPooling_bool(cv::dnn::PoolingLayer* instance, bool val) {
	...
	void cv_dnn_PoolingLayer_propIsGlobalPooling_vectorLboolG(cv::dnn::PoolingLayer* instance, std::vector<bool>* val) {
	...
	void cv_dnn_PoolingLayer_propComputeMaxIdx_bool(cv::dnn::PoolingLayer* instance, bool val) {
	...
	void cv_dnn_PoolingLayer_propPadMode_String(cv::dnn::PoolingLayer* instance, char* val) {
			instance->padMode = std::string(val);
	}
	...
	void cv_dnn_PoolingLayer_propCeilMode_bool(cv::dnn::PoolingLayer* instance, bool val) {
	...
	void cv_dnn_PoolingLayer_propAvePoolPaddedArea_bool(cv::dnn::PoolingLayer* instance, bool val) {
	...
	void cv_dnn_PoolingLayer_propPooledSize_Size(cv::dnn::PoolingLayer* instance, cv::Size* val) {
	...
	void cv_dnn_PoolingLayer_propSpatialScale_float(cv::dnn::PoolingLayer* instance, float val) {
	...
	void cv_dnn_PoolingLayer_propPsRoiOutChannels_int(cv::dnn::PoolingLayer* instance, int val) {
	...
	void cv_dnn_PoolingLayerInt8_propInput_zp_int(cv::dnn::PoolingLayerInt8* instance, int val) {
			instance->input_zp = val;
	}
	...
	void cv_dnn_PoolingLayerInt8_propOutput_zp_int(cv::dnn::PoolingLayerInt8* instance, int val) {
			instance->output_zp = val;
	}
	...
	void cv_dnn_PoolingLayerInt8_propInput_sc_float(cv::dnn::PoolingLayerInt8* instance, float val) {
			instance->input_sc = val;
	}
	...
	void cv_dnn_PoolingLayerInt8_propOutput_sc_float(cv::dnn::PoolingLayerInt8* instance, float val) {
			instance->output_sc = val;
	}
	...
	void cv_dnn_PowerLayer_propPower_float(cv::dnn::PowerLayer* instance, float val) {
			instance->power = val;
	}
	...
	void cv_dnn_PowerLayer_propScale_float(cv::dnn::PowerLayer* instance, float val) {
			instance->scale = val;
	}
	...
	void cv_dnn_PowerLayer_propShift_float(cv::dnn::PowerLayer* instance, float val) {
			instance->shift = val;
	}
	...
	void cv_dnn_QuantizeLayer_propScales_vectorLfloatG(cv::dnn::QuantizeLayer* instance, std::vector<float>* val) {
			instance->scales = *val;
	}
	...
	void cv_dnn_QuantizeLayer_propZeropoints_vectorLintG(cv::dnn::QuantizeLayer* instance, std::vector<int>* val) {
			instance->zeropoints = *val;
	}
	...
	void cv_dnn_ReLU6Layer_propMinValue_float(cv::dnn::ReLU6Layer* instance, float val) {
	...
	void cv_dnn_ReLU6Layer_propMaxValue_float(cv::dnn::ReLU6Layer* instance, float val) {
	...
	void cv_dnn_ReLULayer_propNegativeSlope_float(cv::dnn::ReLULayer* instance, float val) {
	...
	void cv_dnn_RegionLayer_propNmsThreshold_float(cv::dnn::RegionLayer* instance, float val) {
	...
	void cv_dnn_RequantizeLayer_propScale_float(cv::dnn::RequantizeLayer* instance, float val) {
			instance->scale = val;
	}
	...
	void cv_dnn_RequantizeLayer_propShift_float(cv::dnn::RequantizeLayer* instance, float val) {
			instance->shift = val;
	}
	...
	void cv_dnn_ReshapeLayer_propNewShapeDesc_MatShape(cv::dnn::ReshapeLayer* instance, cv::dnn::MatShape* val) {
	...
	void cv_dnn_ReshapeLayer_propNewShapeRange_Range(cv::dnn::ReshapeLayer* instance, cv::Range* val) {
	...
	void cv_dnn_ScaleLayer_propHasBias_bool(cv::dnn::ScaleLayer* instance, bool val) {
			instance->hasBias = val;
	}
	...
	void cv_dnn_ScaleLayer_propAxis_int(cv::dnn::ScaleLayer* instance, int val) {
			instance->axis = val;
	}
	...
	void cv_dnn_ScaleLayer_propMode_String(cv::dnn::ScaleLayer* instance, char* val) {
	...
	void cv_dnn_ScaleLayerInt8_propOutput_sc_float(cv::dnn::ScaleLayerInt8* instance, float val) {
			instance->output_sc = val;
	}
	...
	void cv_dnn_ScaleLayerInt8_propOutput_zp_int(cv::dnn::ScaleLayerInt8* instance, int val) {
			instance->output_zp = val;
	}
	...
	void cv_dnn_ScatterLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::ScatterLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::ScatterLayer>*>, ocvrs_return);
	}
	...
	void cv_dnn_ScatterNDLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::ScatterNDLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::ScatterNDLayer>*>, ocvrs_return);
	}
	...
	void cv_dnn_SeluLayer_propAlpha_float(cv::dnn::SeluLayer* instance, float val) {
			instance->alpha = val;
	}
	...
	void cv_dnn_SeluLayer_propGamma_float(cv::dnn::SeluLayer* instance, float val) {
			instance->gamma = val;
	}
	...
	void cv_dnn_ShrinkLayer_propBias_float(cv::dnn::ShrinkLayer* instance, float val) {
			instance->bias = val;
	}
	...
	void cv_dnn_ShrinkLayer_propLambd_float(cv::dnn::ShrinkLayer* instance, float val) {
			instance->lambd = val;
	}
	...
	void cv_dnn_ShuffleChannelLayer_propGroup_int(cv::dnn::ShuffleChannelLayer* instance, int val) {
			instance->group = val;
	}
	...
	void cv_dnn_SliceLayer_propSliceRanges_vectorLvectorLRangeGG(cv::dnn::SliceLayer* instance, std::vector<std::vector<cv::Range>>* val) {
	...
	void cv_dnn_SliceLayer_propSliceSteps_vectorLvectorLintGG(cv::dnn::SliceLayer* instance, std::vector<std::vector<int>>* val) {
	...
	void cv_dnn_SliceLayer_propAxis_int(cv::dnn::SliceLayer* instance, int val) {
			instance->axis = val;
	}
	...
	void cv_dnn_SliceLayer_propNum_split_int(cv::dnn::SliceLayer* instance, int val) {
	...
	void cv_dnn_SoftmaxLayer_propLogSoftMax_bool(cv::dnn::SoftmaxLayer* instance, bool val) {
	...
	void cv_dnn_SoftmaxLayerInt8_propOutput_sc_float(cv::dnn::SoftmaxLayerInt8* instance, float val) {
			instance->output_sc = val;
	}
	...
	void cv_dnn_SoftmaxLayerInt8_propOutput_zp_int(cv::dnn::SoftmaxLayerInt8* instance, int val) {
			instance->output_zp = val;
	}
	...
	void cv_dnn_SplitLayer_propOutputsCount_int(cv::dnn::SplitLayer* instance, int val) {
	...
	void cv_dnn_ThresholdedReluLayer_propAlpha_float(cv::dnn::ThresholdedReluLayer* instance, float val) {
			instance->alpha = val;
	}
	...
	void cv_dnn_TileLayer_create_const_LayerParamsR(const cv::dnn::LayerParams* params, Result<cv::Ptr<cv::dnn::TileLayer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::dnn::TileLayer>*>, ocvrs_return);
	}
