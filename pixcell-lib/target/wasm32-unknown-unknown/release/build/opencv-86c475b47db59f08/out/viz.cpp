...
extern "C" {
	...
	void cv_viz_KeyboardEvent_propAction_Action(cv::viz::KeyboardEvent* instance, cv::viz::KeyboardEvent::Action val) {
			instance->action = val;
	}
	...
	void cv_viz_KeyboardEvent_propSymbol_String(cv::viz::KeyboardEvent* instance, char* val) {
	...
	void cv_viz_KeyboardEvent_propCode_unsigned_char(cv::viz::KeyboardEvent* instance, unsigned char val) {
			instance->code = val;
	}
	...
	void cv_viz_KeyboardEvent_propModifiers_int(cv::viz::KeyboardEvent* instance, int val) {
	...
	void cv_viz_Mesh_propCloud_Mat(cv::viz::Mesh* instance, cv::Mat* val) {
			instance->cloud = *val;
	}
	...
	void cv_viz_Mesh_propColors_Mat(cv::viz::Mesh* instance, cv::Mat* val) {
			instance->colors = *val;
	}
	...
	void cv_viz_Mesh_propNormals_Mat(cv::viz::Mesh* instance, cv::Mat* val) {
	...
	void cv_viz_Mesh_propPolygons_Mat(cv::viz::Mesh* instance, cv::Mat* val) {
	...
	void cv_viz_Mesh_propTexture_Mat(cv::viz::Mesh* instance, cv::Mat* val) {
	...
	void cv_viz_Mesh_propTcoords_Mat(cv::viz::Mesh* instance, cv::Mat* val) {
	...
	void cv_viz_MouseEvent_propType_Type(cv::viz::MouseEvent* instance, cv::viz::MouseEvent::Type val) {
			instance->type = val;
	}
	...
	void cv_viz_MouseEvent_propButton_MouseButton(cv::viz::MouseEvent* instance, cv::viz::MouseEvent::MouseButton val) {
			instance->button = val;
	}
	...
	void cv_viz_MouseEvent_propPointer_Point(cv::viz::MouseEvent* instance, cv::Point* val) {
	...
	void cv_viz_MouseEvent_propModifiers_int(cv::viz::MouseEvent* instance, int val) {
			instance->modifiers = val;
	}
