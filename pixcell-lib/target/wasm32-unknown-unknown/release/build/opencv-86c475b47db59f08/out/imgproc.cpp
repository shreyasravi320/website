...
extern "C" {
	...
	void cv_stackBlur_const__InputArrayR_const__OutputArrayR_Size(const cv::_InputArray* src, const cv::_OutputArray* dst, cv::Size* ksize, Result_void* ocvrs_return) {
		try {
