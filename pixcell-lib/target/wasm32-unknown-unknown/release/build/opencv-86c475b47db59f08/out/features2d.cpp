...
extern "C" {
	...
	void cv_BRISK_setPatternScale_float(cv::BRISK* instance, float patternScale, Result_void* ocvrs_return) {
		try {
	...
	void cv_DescriptorMatcher_write_const_FileStorageR_const_StringR(const cv::DescriptorMatcher* instance, cv::FileStorage* fs, const char* name, Result_void* ocvrs_return) {
		try {
	...
	void cv_Feature2D_write_const_FileStorageR_const_StringR(const cv::Feature2D* instance, cv::FileStorage* fs, const char* name, Result_void* ocvrs_return) {
		try {
			instance->write(*fs, std::string(name));
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_GFTTDetector_setGradientSize_int(cv::GFTTDetector* instance, int gradientSize_, Result_void* ocvrs_return) {
		try {
	...
	void cv_KeyPointsFilter_runByPixelsMask2VectorPoint_vectorLKeyPointGR_vectorLvectorLPointGGR_const_MatR(std::vector<cv::KeyPoint>* keypoints, std::vector<std::vector<cv::Point>>* removeFrom, const cv::Mat* mask, Result_void* ocvrs_return) {
		try {
	...
	void cv_MSER_setMaxVariation_double(cv::MSER* instance, double maxVariation, Result_void* ocvrs_return) {
		try {
	...
	void cv_MSER_setMinDiversity_double(cv::MSER* instance, double minDiversity, Result_void* ocvrs_return) {
		try {
	...
	void cv_MSER_setMaxEvolution_int(cv::MSER* instance, int maxEvolution, Result_void* ocvrs_return) {
		try {
	...
	void cv_MSER_setAreaThreshold_double(cv::MSER* instance, double areaThreshold, Result_void* ocvrs_return) {
		try {
	...
	void cv_MSER_setMinMargin_double(cv::MSER* instance, double min_margin, Result_void* ocvrs_return) {
		try {
	...
	void cv_MSER_setEdgeBlurSize_int(cv::MSER* instance, int edge_blur_size, Result_void* ocvrs_return) {
		try {
	...
	void cv_SIFT_setNFeatures_int(cv::SIFT* instance, int maxFeatures, Result_void* ocvrs_return) {
		try {
	...
	void cv_SIFT_setNOctaveLayers_int(cv::SIFT* instance, int nOctaveLayers, Result_void* ocvrs_return) {
		try {
	...
	void cv_SIFT_setContrastThreshold_double(cv::SIFT* instance, double contrastThreshold, Result_void* ocvrs_return) {
		try {
	...
	void cv_SIFT_setEdgeThreshold_double(cv::SIFT* instance, double edgeThreshold, Result_void* ocvrs_return) {
		try {
			instance->setEdgeThreshold(edgeThreshold);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_SIFT_setSigma_double(cv::SIFT* instance, double sigma, Result_void* ocvrs_return) {
		try {
	...
	void cv_SimpleBlobDetector_setParams_const_ParamsR(cv::SimpleBlobDetector* instance, const cv::SimpleBlobDetector::Params* params, Result_void* ocvrs_return) {
		try {
