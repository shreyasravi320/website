...
extern "C" {
	...
	void cv_optflow_GPCPatchDescriptor_propFeature_VecLdouble__18G(cv::optflow::GPCPatchDescriptor* instance, cv::Vec<double, 18>* val) {
	...
	void cv_optflow_GPCPatchSample_propRef_GPCPatchDescriptor(cv::optflow::GPCPatchSample* instance, cv::optflow::GPCPatchDescriptor* val) {
			instance->ref = *val;
	}
	...
	void cv_optflow_GPCPatchSample_propPos_GPCPatchDescriptor(cv::optflow::GPCPatchSample* instance, cv::optflow::GPCPatchDescriptor* val) {
			instance->pos = *val;
	}
	...
	void cv_optflow_GPCPatchSample_propNeg_GPCPatchDescriptor(cv::optflow::GPCPatchSample* instance, cv::optflow::GPCPatchDescriptor* val) {
			instance->neg = *val;
	}
	...
	void cv_optflow_RLOFOpticalFlowParameter_propSolverType_SolverType(cv::optflow::RLOFOpticalFlowParameter* instance, cv::optflow::SolverType val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propSupportRegionType_SupportRegionType(cv::optflow::RLOFOpticalFlowParameter* instance, cv::optflow::SupportRegionType val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propNormSigma0_float(cv::optflow::RLOFOpticalFlowParameter* instance, float val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propNormSigma1_float(cv::optflow::RLOFOpticalFlowParameter* instance, float val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propSmallWinSize_int(cv::optflow::RLOFOpticalFlowParameter* instance, int val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propLargeWinSize_int(cv::optflow::RLOFOpticalFlowParameter* instance, int val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propCrossSegmentationThreshold_int(cv::optflow::RLOFOpticalFlowParameter* instance, int val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propMaxLevel_int(cv::optflow::RLOFOpticalFlowParameter* instance, int val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propUseInitialFlow_bool(cv::optflow::RLOFOpticalFlowParameter* instance, bool val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propUseIlluminationModel_bool(cv::optflow::RLOFOpticalFlowParameter* instance, bool val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propUseGlobalMotionPrior_bool(cv::optflow::RLOFOpticalFlowParameter* instance, bool val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propMaxIteration_int(cv::optflow::RLOFOpticalFlowParameter* instance, int val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propMinEigenValue_float(cv::optflow::RLOFOpticalFlowParameter* instance, float val) {
	...
	void cv_optflow_RLOFOpticalFlowParameter_propGlobalMotionRansacThreshold_float(cv::optflow::RLOFOpticalFlowParameter* instance, float val) {
