...
extern "C" {
	...
	void cv_multicalib_MultiCameraCalibration_edge_propCameraVertex_int(cv::multicalib::MultiCameraCalibration::edge* instance, int val) {
	...
	void cv_multicalib_MultiCameraCalibration_edge_propPhotoVertex_int(cv::multicalib::MultiCameraCalibration::edge* instance, int val) {
	...
	void cv_multicalib_MultiCameraCalibration_edge_propPhotoIndex_int(cv::multicalib::MultiCameraCalibration::edge* instance, int val) {
	...
	void cv_multicalib_MultiCameraCalibration_edge_propTransform_Mat(cv::multicalib::MultiCameraCalibration::edge* instance, cv::Mat* val) {
	...
	void cv_multicalib_MultiCameraCalibration_vertex_propPose_Mat(cv::multicalib::MultiCameraCalibration::vertex* instance, cv::Mat* val) {
			instance->pose = *val;
	}
	...
	void cv_multicalib_MultiCameraCalibration_vertex_propTimestamp_int(cv::multicalib::MultiCameraCalibration::vertex* instance, int val) {
