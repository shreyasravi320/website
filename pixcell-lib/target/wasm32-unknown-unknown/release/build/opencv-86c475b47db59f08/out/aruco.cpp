...
extern "C" {
	...
	void cv_aruco_EstimateParameters_EstimateParameters(Result<cv::aruco::EstimateParameters*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::aruco::EstimateParameters*>, ocvrs_return);
	}
	...
	void cv_aruco_EstimateParameters_propPattern_PatternPositionType(cv::aruco::EstimateParameters* instance, cv::aruco::PatternPositionType val) {
	...
	void cv_aruco_EstimateParameters_propUseExtrinsicGuess_bool(cv::aruco::EstimateParameters* instance, bool val) {
	...
	void cv_aruco_EstimateParameters_propSolvePnPMethod_int(cv::aruco::EstimateParameters* instance, int val) {
