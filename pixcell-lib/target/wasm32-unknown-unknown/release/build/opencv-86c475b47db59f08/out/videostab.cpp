...
extern "C" {
	...
	void cv_videostab_RansacParams_propSize_int(cv::videostab::RansacParams* instance, int val) {
			instance->size = val;
	}
	...
	void cv_videostab_RansacParams_propThresh_float(cv::videostab::RansacParams* instance, float val) {
			instance->thresh = val;
	}
	...
	void cv_videostab_RansacParams_propEps_float(cv::videostab::RansacParams* instance, float val) {
			instance->eps = val;
	}
	...
	void cv_videostab_RansacParams_propProb_float(cv::videostab::RansacParams* instance, float val) {
			instance->prob = val;
	}
