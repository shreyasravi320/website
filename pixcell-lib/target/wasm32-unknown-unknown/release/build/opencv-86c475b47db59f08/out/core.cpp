...
extern "C" {
	...
	void cv_detail_check_failed_auto_const_bool_const_bool_const_CheckContextR(const bool v1, const bool v2, const cv::detail::CheckContext* ctx, Result_void* ocvrs_return) {
		try {
			cv::detail::check_failed_auto(v1, v2, *ctx);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_check_failed_false_const_bool_const_CheckContextR(const bool v, const cv::detail::CheckContext* ctx, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_check_failed_true_const_bool_const_CheckContextR(const bool v, const cv::detail::CheckContext* ctx, Result_void* ocvrs_return) {
		try {
	...
	void cv_flipND_const__InputArrayR_const__OutputArrayR_int(const cv::_InputArray* src, const cv::_OutputArray* dst, int axis, Result_void* ocvrs_return) {
		try {
	...
	void cv_ocl_convertTypeStr_int_int_int_charX_size_t(int sdepth, int ddepth, int cn, void** buf, size_t buf_size, Result<void*>* ocvrs_return) {
		try {
			char* buf_out = new char[1024]();
			const char* ret = cv::ocl::convertTypeStr(sdepth, ddepth, cn, buf_out, buf_size);
			*buf = ocvrs_create_string(buf_out);
			void* ret_1 = ocvrs_create_string(ret);
			delete[] buf_out;
			Ok(ret_1, ocvrs_return);
	...
	void cv_Algorithm_write_const_FileStorageR_const_StringR(const cv::Algorithm* instance, cv::FileStorage* fs, const char* name, Result_void* ocvrs_return) {
		try {
	...
	void cv_RotatedRect_points_const_vectorLPoint2fGR(const cv::RotatedRect* instance, std::vector<cv::Point2f>* pts, Result_void* ocvrs_return) {
		try {
			instance->points(*pts);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_utils_ClassWithKeywordProperties_ClassWithKeywordProperties_int_int(int lambda_arg, int except_arg, Result<cv::utils::ClassWithKeywordProperties>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::utils::ClassWithKeywordProperties>, ocvrs_return);
	}
	...
	void cv_utils_FunctionParams_propLambda_int(cv::utils::FunctionParams* instance, int val) {
			instance->lambda = val;
	}
	...
	void cv_utils_FunctionParams_propSigma_float(cv::utils::FunctionParams* instance, float val) {
			instance->sigma = val;
	}
