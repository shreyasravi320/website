...
extern "C" {
	...
	void cv_cuda_fastNlMeansDenoisingColored_const_GpuMatR_GpuMatR_float_float_int_int_StreamR(const cv::cuda::GpuMat* src, cv::cuda::GpuMat* dst, float h_luminance, float photo_render, int search_window, int block_size, cv::cuda::Stream* stream, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_fastNlMeansDenoising_const_GpuMatR_GpuMatR_float_int_int_StreamR(const cv::cuda::GpuMat* src, cv::cuda::GpuMat* dst, float h, int search_window, int block_size, cv::cuda::Stream* stream, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_nonLocalMeans_const_GpuMatR_GpuMatR_float_int_int_int_StreamR(const cv::cuda::GpuMat* src, cv::cuda::GpuMat* dst, float h, int search_window, int block_size, int borderMode, cv::cuda::Stream* stream, Result_void* ocvrs_return) {
		try {
