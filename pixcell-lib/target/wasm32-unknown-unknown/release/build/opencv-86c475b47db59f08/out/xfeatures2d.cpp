...
extern "C" {
	void cv_xfeatures2d_FASTForPointSet_const__InputArrayR_vectorLKeyPointGR_int_bool_DetectorType(const cv::_InputArray* image, std::vector<cv::KeyPoint>* keypoints, int threshold, bool nonmaxSuppression, cv::FastFeatureDetector::DetectorType type, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_SURF_CUDA_SURF_CUDA(Result<cv::cuda::SURF_CUDA*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::SURF_CUDA*>, ocvrs_return);
	}
	...
	void cv_cuda_SURF_CUDA_create_double_int_int_bool_float_bool(double _hessianThreshold, int _nOctaves, int _nOctaveLayers, bool _extended, float _keypointsRatio, bool _upright, Result<cv::Ptr<cv::cuda::SURF_CUDA>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::cuda::SURF_CUDA>*>, ocvrs_return);
	}
	...
	void cv_cuda_SURF_CUDA_uploadKeypoints_const_vectorLKeyPointGR_GpuMatR(cv::cuda::SURF_CUDA* instance, const std::vector<cv::KeyPoint>* keypoints, cv::cuda::GpuMat* keypointsGPU, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_SURF_CUDA_downloadKeypoints_const_GpuMatR_vectorLKeyPointGR(cv::cuda::SURF_CUDA* instance, const cv::cuda::GpuMat* keypointsGPU, std::vector<cv::KeyPoint>* keypoints, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_SURF_CUDA_downloadDescriptors_const_GpuMatR_vectorLfloatGR(cv::cuda::SURF_CUDA* instance, const cv::cuda::GpuMat* descriptorsGPU, std::vector<float>* descriptors, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_SURF_CUDA_operator___const_GpuMatR_const_GpuMatR_GpuMatR(cv::cuda::SURF_CUDA* instance, const cv::cuda::GpuMat* img, const cv::cuda::GpuMat* mask, cv::cuda::GpuMat* keypoints, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_SURF_CUDA_operator___const_GpuMatR_const_GpuMatR_GpuMatR_GpuMatR_bool(cv::cuda::SURF_CUDA* instance, const cv::cuda::GpuMat* img, const cv::cuda::GpuMat* mask, cv::cuda::GpuMat* keypoints, cv::cuda::GpuMat* descriptors, bool useProvidedKeypoints, Result_void* ocvrs_return) {
		try {
	...
	void cv_cuda_SURF_CUDA_operator___const_GpuMatR_const_GpuMatR_vectorLKeyPointGR(cv::cuda::SURF_CUDA* instance, const cv::cuda::GpuMat* img, const cv::cuda::GpuMat* mask, std::vector<cv::KeyPoint>* keypoints, Result_void* ocvrs_return) {
		try {
			instance->operator()(*img, *mask, *keypoints);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_cuda_SURF_CUDA_operator___const_GpuMatR_const_GpuMatR_vectorLKeyPointGR_GpuMatR_bool(cv::cuda::SURF_CUDA* instance, const cv::cuda::GpuMat* img, const cv::cuda::GpuMat* mask, std::vector<cv::KeyPoint>* keypoints, cv::cuda::GpuMat* descriptors, bool useProvidedKeypoints, Result_void* ocvrs_return) {
		try {
			instance->operator()(*img, *mask, *keypoints, *descriptors, useProvidedKeypoints);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_cuda_SURF_CUDA_operator___const_GpuMatR_const_GpuMatR_vectorLKeyPointGR_vectorLfloatGR_bool(cv::cuda::SURF_CUDA* instance, const cv::cuda::GpuMat* img, const cv::cuda::GpuMat* mask, std::vector<cv::KeyPoint>* keypoints, std::vector<float>* descriptors, bool useProvidedKeypoints, Result_void* ocvrs_return) {
		try {
			instance->operator()(*img, *mask, *keypoints, *descriptors, useProvidedKeypoints);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_cuda_SURF_CUDA_propHessianThreshold_double(cv::cuda::SURF_CUDA* instance, double val) {
	...
	void cv_cuda_SURF_CUDA_propNOctaves_int(cv::cuda::SURF_CUDA* instance, int val) {
	...
	void cv_cuda_SURF_CUDA_propNOctaveLayers_int(cv::cuda::SURF_CUDA* instance, int val) {
	...
	void cv_cuda_SURF_CUDA_propExtended_bool(cv::cuda::SURF_CUDA* instance, bool val) {
	...
	void cv_cuda_SURF_CUDA_propUpright_bool(cv::cuda::SURF_CUDA* instance, bool val) {
	...
	void cv_cuda_SURF_CUDA_propKeypointsRatio_float(cv::cuda::SURF_CUDA* instance, float val) {
	...
	void cv_cuda_SURF_CUDA_propSum_GpuMat(cv::cuda::SURF_CUDA* instance, cv::cuda::GpuMat* val) {
			instance->sum = *val;
	}
	...
	void cv_cuda_SURF_CUDA_propMask1_GpuMat(cv::cuda::SURF_CUDA* instance, cv::cuda::GpuMat* val) {
			instance->mask1 = *val;
	}
	...
	void cv_cuda_SURF_CUDA_propMaskSum_GpuMat(cv::cuda::SURF_CUDA* instance, cv::cuda::GpuMat* val) {
	...
	void cv_cuda_SURF_CUDA_propDet_GpuMat(cv::cuda::SURF_CUDA* instance, cv::cuda::GpuMat* val) {
			instance->det = *val;
	}
	...
	void cv_cuda_SURF_CUDA_propTrace_GpuMat(cv::cuda::SURF_CUDA* instance, cv::cuda::GpuMat* val) {
			instance->trace = *val;
	}
	...
	void cv_cuda_SURF_CUDA_propMaxPosBuffer_GpuMat(cv::cuda::SURF_CUDA* instance, cv::cuda::GpuMat* val) {
	...
	void cv_xfeatures2d_AffineFeature2D_create_PtrLFeature2DG_PtrLFeature2DG(cv::Ptr<cv::Feature2D>* keypoint_detector, cv::Ptr<cv::Feature2D>* descriptor_extractor, Result<cv::Ptr<cv::xfeatures2d::AffineFeature2D>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::AffineFeature2D>*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_AffineFeature2D_detect_const__InputArrayR_vectorLElliptic_KeyPointGR_const__InputArrayR(cv::xfeatures2d::AffineFeature2D* instance, const cv::_InputArray* image, std::vector<cv::xfeatures2d::Elliptic_KeyPoint>* keypoints, const cv::_InputArray* mask, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_BEBLID_create_float_int(float scale_factor, int n_bits, Result<cv::Ptr<cv::xfeatures2d::BEBLID>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::BEBLID>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_BEBLID_setScaleFactor_float(cv::xfeatures2d::BEBLID* instance, float scale_factor, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_BoostDesc_create_int_bool_float(int desc, bool use_scale_orientation, float scale_factor, Result<cv::Ptr<cv::xfeatures2d::BoostDesc>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::BoostDesc>*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_BriefDescriptorExtractor_create_int_bool(int bytes, bool use_orientation, Result<cv::Ptr<cv::xfeatures2d::BriefDescriptorExtractor>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::BriefDescriptorExtractor>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_BriefDescriptorExtractor_setDescriptorSize_int(cv::xfeatures2d::BriefDescriptorExtractor* instance, int bytes, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_BriefDescriptorExtractor_setUseOrientation_bool(cv::xfeatures2d::BriefDescriptorExtractor* instance, bool use_orientation, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_create_float_int_int_int_NormalizationType_const__InputArrayR_bool_bool(float radius, int q_radius, int q_theta, int q_hist, cv::xfeatures2d::DAISY::NormalizationType norm, const cv::_InputArray* H, bool interpolation, bool use_orientation, Result<cv::Ptr<cv::xfeatures2d::DAISY>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::DAISY>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_DAISY_setRadius_float(cv::xfeatures2d::DAISY* instance, float radius, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_setQRadius_int(cv::xfeatures2d::DAISY* instance, int q_radius, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_setQTheta_int(cv::xfeatures2d::DAISY* instance, int q_theta, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_setQHist_int(cv::xfeatures2d::DAISY* instance, int q_hist, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_setNorm_int(cv::xfeatures2d::DAISY* instance, int norm, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_setH_const__InputArrayR(cv::xfeatures2d::DAISY* instance, const cv::_InputArray* H, Result_void* ocvrs_return) {
		try {
			instance->setH(*H);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_xfeatures2d_DAISY_setInterpolation_bool(cv::xfeatures2d::DAISY* instance, bool interpolation, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_setUseOrientation_bool(cv::xfeatures2d::DAISY* instance, bool use_orientation, Result_void* ocvrs_return) {
		try {
			instance->setUseOrientation(use_orientation);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_xfeatures2d_DAISY_compute_const__InputArrayR_vectorLKeyPointGR_const__OutputArrayR(cv::xfeatures2d::DAISY* instance, const cv::_InputArray* image, std::vector<cv::KeyPoint>* keypoints, const cv::_OutputArray* descriptors, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_DAISY_compute_const__InputArrayR_vectorLvectorLKeyPointGGR_const__OutputArrayR(cv::xfeatures2d::DAISY* instance, const cv::_InputArray* images, std::vector<std::vector<cv::KeyPoint>>* keypoints, const cv::_OutputArray* descriptors, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_Elliptic_KeyPoint_Elliptic_KeyPoint(Result<cv::xfeatures2d::Elliptic_KeyPoint*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::xfeatures2d::Elliptic_KeyPoint*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_Elliptic_KeyPoint_propAxes_Size_LfloatG(cv::xfeatures2d::Elliptic_KeyPoint* instance, cv::Size_<float>* val) {
			instance->axes = *val;
	}
	...
	void cv_xfeatures2d_Elliptic_KeyPoint_propSi_float(cv::xfeatures2d::Elliptic_KeyPoint* instance, float val) {
			instance->si = val;
	}
	...
	void cv_xfeatures2d_Elliptic_KeyPoint_propTransf_Matx23f(cv::xfeatures2d::Elliptic_KeyPoint* instance, cv::Matx23f* val) {
			instance->transf = *val;
	}
	...
	void cv_xfeatures2d_FREAK_create_bool_bool_float_int_const_vectorLintGR(bool orientationNormalized, bool scaleNormalized, float patternScale, int nOctaves, const std::vector<int>* selectedPairs, Result<cv::Ptr<cv::xfeatures2d::FREAK>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::FREAK>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_FREAK_setOrientationNormalized_bool(cv::xfeatures2d::FREAK* instance, bool orientationNormalized, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_FREAK_setScaleNormalized_bool(cv::xfeatures2d::FREAK* instance, bool scaleNormalized, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_FREAK_setPatternScale_double(cv::xfeatures2d::FREAK* instance, double patternScale, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_FREAK_setNOctaves_int(cv::xfeatures2d::FREAK* instance, int nOctaves, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_HarrisLaplaceFeatureDetector_create_int_float_float_int_int(int numOctaves, float corn_thresh, float DOG_thresh, int maxCorners, int num_layers, Result<cv::Ptr<cv::xfeatures2d::HarrisLaplaceFeatureDetector>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::HarrisLaplaceFeatureDetector>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_HarrisLaplaceFeatureDetector_setNumOctaves_int(cv::xfeatures2d::HarrisLaplaceFeatureDetector* instance, int numOctaves_, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_HarrisLaplaceFeatureDetector_setCornThresh_float(cv::xfeatures2d::HarrisLaplaceFeatureDetector* instance, float corn_thresh_, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_HarrisLaplaceFeatureDetector_setDOGThresh_float(cv::xfeatures2d::HarrisLaplaceFeatureDetector* instance, float DOG_thresh_, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_HarrisLaplaceFeatureDetector_setMaxCorners_int(cv::xfeatures2d::HarrisLaplaceFeatureDetector* instance, int maxCorners_, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_HarrisLaplaceFeatureDetector_setNumLayers_int(cv::xfeatures2d::HarrisLaplaceFeatureDetector* instance, int num_layers_, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_LATCH_create_int_bool_int_double(int bytes, bool rotationInvariance, int half_ssd_size, double sigma, Result<cv::Ptr<cv::xfeatures2d::LATCH>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::LATCH>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_LATCH_setBytes_int(cv::xfeatures2d::LATCH* instance, int bytes, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_LATCH_setRotationInvariance_bool(cv::xfeatures2d::LATCH* instance, bool rotationInvariance, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_LATCH_setHalfSSDsize_int(cv::xfeatures2d::LATCH* instance, int half_ssd_size, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_LATCH_setSigma_double(cv::xfeatures2d::LATCH* instance, double sigma, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_LUCID_create_const_int_const_int(const int lucid_kernel, const int blur_kernel, Result<cv::Ptr<cv::xfeatures2d::LUCID>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::LUCID>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_LUCID_setLucidKernel_int(cv::xfeatures2d::LUCID* instance, int lucid_kernel, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_LUCID_setBlurKernel_int(cv::xfeatures2d::LUCID* instance, int blur_kernel, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_MSDDetector_create_int_int_int_int_float_int_float_int_bool(int m_patch_radius, int m_search_area_radius, int m_nms_radius, int m_nms_scale_radius, float m_th_saliency, int m_kNN, float m_scale_factor, int m_n_scales, bool m_compute_orientation, Result<cv::Ptr<cv::xfeatures2d::MSDDetector>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::MSDDetector>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_MSDDetector_setPatchRadius_int(cv::xfeatures2d::MSDDetector* instance, int patch_radius, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_MSDDetector_setSearchAreaRadius_int(cv::xfeatures2d::MSDDetector* instance, int use_orientation, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_MSDDetector_setNmsRadius_int(cv::xfeatures2d::MSDDetector* instance, int nms_radius, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_MSDDetector_setNmsScaleRadius_int(cv::xfeatures2d::MSDDetector* instance, int nms_scale_radius, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_MSDDetector_setThSaliency_float(cv::xfeatures2d::MSDDetector* instance, float th_saliency, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_MSDDetector_setKNN_int(cv::xfeatures2d::MSDDetector* instance, int kNN, Result_void* ocvrs_return) {
		try {
			instance->setKNN(kNN);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_xfeatures2d_MSDDetector_setScaleFactor_float(cv::xfeatures2d::MSDDetector* instance, float scale_factor, Result_void* ocvrs_return) {
		try {
			instance->setScaleFactor(scale_factor);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_xfeatures2d_MSDDetector_setNScales_int(cv::xfeatures2d::MSDDetector* instance, int use_orientation, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_MSDDetector_setComputeOrientation_bool(cv::xfeatures2d::MSDDetector* instance, bool compute_orientation, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_PCTSignatures_create_const_int_const_int_const_int(const int initSampleCount, const int initSeedCount, const int pointDistribution, Result<cv::Ptr<cv::xfeatures2d::PCTSignatures>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::PCTSignatures>*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_PCTSignatures_computeSignatures_const_const_vectorLMatGR_vectorLMatGR(const cv::xfeatures2d::PCTSignatures* instance, const std::vector<cv::Mat>* images, std::vector<cv::Mat>* signatures, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_PCTSignatures_generateInitPoints_vectorLPoint2fGR_const_int_int(std::vector<cv::Point2f>* initPoints, const int count, int pointDistribution, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_PCTSignatures_setWeights_const_vectorLfloatGR(cv::xfeatures2d::PCTSignatures* instance, const std::vector<float>* weights, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_PCTSignatures_setTranslations_const_vectorLfloatGR(cv::xfeatures2d::PCTSignatures* instance, const std::vector<float>* translations, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_PCTSignatures_setSamplingPoints_vectorLPoint2fG(cv::xfeatures2d::PCTSignatures* instance, std::vector<cv::Point2f>* samplingPoints, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_PCTSignatures_setInitSeedIndexes_vectorLintG(cv::xfeatures2d::PCTSignatures* instance, std::vector<int>* initSeedIndexes, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_PCTSignaturesSQFD_create_const_int_const_int_const_float(const int distanceFunction, const int similarityFunction, const float similarityParameter, Result<cv::Ptr<cv::xfeatures2d::PCTSignaturesSQFD>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::PCTSignaturesSQFD>*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_PCTSignaturesSQFD_computeQuadraticFormDistances_const_const_MatR_const_vectorLMatGR_vectorLfloatGR(const cv::xfeatures2d::PCTSignaturesSQFD* instance, const cv::Mat* sourceSignature, const std::vector<cv::Mat>* imageSignatures, std::vector<float>* distances, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_SURF_create_double_int_int_bool_bool(double hessianThreshold, int nOctaves, int nOctaveLayers, bool extended, bool upright, Result<cv::Ptr<cv::xfeatures2d::SURF>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::SURF>*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_StarDetector_create_int_int_int_int_int(int maxSize, int responseThreshold, int lineThresholdProjected, int lineThresholdBinarized, int suppressNonmaxSize, Result<cv::Ptr<cv::xfeatures2d::StarDetector>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::StarDetector>*>, ocvrs_return);
	}
	
	void cv_xfeatures2d_StarDetector_setMaxSize_int(cv::xfeatures2d::StarDetector* instance, int _maxSize, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_StarDetector_setResponseThreshold_int(cv::xfeatures2d::StarDetector* instance, int _responseThreshold, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_StarDetector_setLineThresholdProjected_int(cv::xfeatures2d::StarDetector* instance, int _lineThresholdProjected, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_StarDetector_setLineThresholdBinarized_int(cv::xfeatures2d::StarDetector* instance, int _lineThresholdBinarized, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_StarDetector_setSuppressNonmaxSize_int(cv::xfeatures2d::StarDetector* instance, int _suppressNonmaxSize, Result_void* ocvrs_return) {
		try {
	...
	void cv_xfeatures2d_TBMR_create_int_float_float_int(int min_area, float max_area_relative, float scale_factor, int n_scales, Result<cv::Ptr<cv::xfeatures2d::TBMR>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::TBMR>*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_TEBLID_create_float_int(float scale_factor, int n_bits, Result<cv::Ptr<cv::xfeatures2d::TEBLID>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::TEBLID>*>, ocvrs_return);
	}
	...
	void cv_xfeatures2d_VGG_create_int_float_bool_bool_float_bool(int desc, float isigma, bool img_normalize, bool use_scale_orientation, float scale_factor, bool dsc_normalize, Result<cv::Ptr<cv::xfeatures2d::VGG>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xfeatures2d::VGG>*>, ocvrs_return);
	}
