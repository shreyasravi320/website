...
extern "C" {
	...
	void cv_face_CParams_propCascade_String(cv::face::CParams* instance, char* val) {
	...
	void cv_face_CParams_propScaleFactor_double(cv::face::CParams* instance, double val) {
	...
	void cv_face_CParams_propMinNeighbors_int(cv::face::CParams* instance, int val) {
	...
	void cv_face_CParams_propMinSize_Size(cv::face::CParams* instance, cv::Size* val) {
	...
	void cv_face_CParams_propMaxSize_Size(cv::face::CParams* instance, cv::Size* val) {
	...
	void cv_face_CParams_propFace_cascade_CascadeClassifier(cv::face::CParams* instance, cv::CascadeClassifier* val) {
	...
	void cv_face_FacemarkAAM_Config_propR_Mat(cv::face::FacemarkAAM::Config* instance, cv::Mat* val) {
			instance->R = *val;
	}
	...
	void cv_face_FacemarkAAM_Config_propT_Point2f(cv::face::FacemarkAAM::Config* instance, cv::Point2f* val) {
			instance->t = *val;
	}
	...
	void cv_face_FacemarkAAM_Config_propScale_float(cv::face::FacemarkAAM::Config* instance, float val) {
			instance->scale = val;
	}
	...
	void cv_face_FacemarkAAM_Config_propModel_scale_idx_int(cv::face::FacemarkAAM::Config* instance, int val) {
	...
	void cv_face_FacemarkAAM_Data_propS0_vectorLPoint2fG(cv::face::FacemarkAAM::Data* instance, std::vector<cv::Point2f>* val) {
			instance->s0 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_propScales_vectorLfloatG(cv::face::FacemarkAAM::Model* instance, std::vector<float>* val) {
			instance->scales = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_propTriangles_vectorLVec3iG(cv::face::FacemarkAAM::Model* instance, std::vector<cv::Vec3i>* val) {
	...
	void cv_face_FacemarkAAM_Model_propTextures_vectorLTextureG(cv::face::FacemarkAAM::Model* instance, std::vector<cv::face::FacemarkAAM::Model::Texture>* val) {
	...
	void cv_face_FacemarkAAM_Model_propS0_vectorLPoint2fG(cv::face::FacemarkAAM::Model* instance, std::vector<cv::Point2f>* val) {
			instance->s0 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_propS_Mat(cv::face::FacemarkAAM::Model* instance, cv::Mat* val) {
			instance->S = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_propQ_Mat(cv::face::FacemarkAAM::Model* instance, cv::Mat* val) {
			instance->Q = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_propMax_m_int(cv::face::FacemarkAAM::Model::Texture* instance, int val) {
			instance->max_m = val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_propResolution_Rect(cv::face::FacemarkAAM::Model::Texture* instance, cv::Rect* val) {
	...
	void cv_face_FacemarkAAM_Model_Texture_propA_Mat(cv::face::FacemarkAAM::Model::Texture* instance, cv::Mat* val) {
			instance->A = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_propA0_Mat(cv::face::FacemarkAAM::Model::Texture* instance, cv::Mat* val) {
			instance->A0 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_propAA_Mat(cv::face::FacemarkAAM::Model::Texture* instance, cv::Mat* val) {
			instance->AA = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_propAA0_Mat(cv::face::FacemarkAAM::Model::Texture* instance, cv::Mat* val) {
			instance->AA0 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_propTextureIdx_vectorLvectorLPointGG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<std::vector<cv::Point>>* val) {
	...
	void cv_face_FacemarkAAM_Model_Texture_propBase_shape_vectorLPoint2fG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<cv::Point2f>* val) {
	...
	void cv_face_FacemarkAAM_Model_Texture_propInd1_vectorLintG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<int>* val) {
			instance->ind1 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_propInd2_vectorLintG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<int>* val) {
			instance->ind2 = *val;
	}
	...
	void cv_face_FacemarkAAM_Params_propModel_filename_string(cv::face::FacemarkAAM::Params* instance, char* val) {
	...
	void cv_face_FacemarkAAM_Params_propM_int(cv::face::FacemarkAAM::Params* instance, int val) {
			instance->m = val;
	}
	...
	void cv_face_FacemarkAAM_Params_propN_int(cv::face::FacemarkAAM::Params* instance, int val) {
			instance->n = val;
	}
	...
	void cv_face_FacemarkAAM_Params_propN_iter_int(cv::face::FacemarkAAM::Params* instance, int val) {
			instance->n_iter = val;
	}
	...
	void cv_face_FacemarkAAM_Params_propVerbose_bool(cv::face::FacemarkAAM::Params* instance, bool val) {
	...
	void cv_face_FacemarkAAM_Params_propSave_model_bool(cv::face::FacemarkAAM::Params* instance, bool val) {
	...
	void cv_face_FacemarkAAM_Params_propMax_m_int(cv::face::FacemarkAAM::Params* instance, int val) {
			instance->max_m = val;
	}
	...
	void cv_face_FacemarkAAM_Params_propMax_n_int(cv::face::FacemarkAAM::Params* instance, int val) {
			instance->max_n = val;
	}
	...
	void cv_face_FacemarkAAM_Params_propTexture_max_m_int(cv::face::FacemarkAAM::Params* instance, int val) {
	...
	void cv_face_FacemarkAAM_Params_propScales_vectorLfloatG(cv::face::FacemarkAAM::Params* instance, std::vector<float>* val) {
			instance->scales = *val;
	}
	...
	void cv_face_FacemarkKazemi_Params_propCascade_depth_unsigned_long(cv::face::FacemarkKazemi::Params* instance, unsigned long val) {
	...
	void cv_face_FacemarkKazemi_Params_propTree_depth_unsigned_long(cv::face::FacemarkKazemi::Params* instance, unsigned long val) {
	...
	void cv_face_FacemarkKazemi_Params_propNum_trees_per_cascade_level_unsigned_long(cv::face::FacemarkKazemi::Params* instance, unsigned long val) {
	...
	void cv_face_FacemarkKazemi_Params_propLearning_rate_float(cv::face::FacemarkKazemi::Params* instance, float val) {
	...
	void cv_face_FacemarkKazemi_Params_propOversampling_amount_unsigned_long(cv::face::FacemarkKazemi::Params* instance, unsigned long val) {
	...
	void cv_face_FacemarkKazemi_Params_propNum_test_coordinates_unsigned_long(cv::face::FacemarkKazemi::Params* instance, unsigned long val) {
	...
	void cv_face_FacemarkKazemi_Params_propLambda_float(cv::face::FacemarkKazemi::Params* instance, float val) {
			instance->lambda = val;
	}
	...
	void cv_face_FacemarkKazemi_Params_propNum_test_splits_unsigned_long(cv::face::FacemarkKazemi::Params* instance, unsigned long val) {
	...
	void cv_face_FacemarkKazemi_Params_propConfigfile_String(cv::face::FacemarkKazemi::Params* instance, char* val) {
	...
	void cv_face_FacemarkLBF_Params_propShape_offset_double(cv::face::FacemarkLBF::Params* instance, double val) {
	...
	void cv_face_FacemarkLBF_Params_propCascade_face_String(cv::face::FacemarkLBF::Params* instance, char* val) {
	...
	void cv_face_FacemarkLBF_Params_propVerbose_bool(cv::face::FacemarkLBF::Params* instance, bool val) {
			instance->verbose = val;
	}
	...
	void cv_face_FacemarkLBF_Params_propN_landmarks_int(cv::face::FacemarkLBF::Params* instance, int val) {
	...
	void cv_face_FacemarkLBF_Params_propInitShape_n_int(cv::face::FacemarkLBF::Params* instance, int val) {
	...
	void cv_face_FacemarkLBF_Params_propStages_n_int(cv::face::FacemarkLBF::Params* instance, int val) {
	...
	void cv_face_FacemarkLBF_Params_propTree_n_int(cv::face::FacemarkLBF::Params* instance, int val) {
			instance->tree_n = val;
	}
	...
	void cv_face_FacemarkLBF_Params_propTree_depth_int(cv::face::FacemarkLBF::Params* instance, int val) {
			instance->tree_depth = val;
	}
	...
	void cv_face_FacemarkLBF_Params_propBagging_overlap_double(cv::face::FacemarkLBF::Params* instance, double val) {
	...
	void cv_face_FacemarkLBF_Params_propModel_filename_string(cv::face::FacemarkLBF::Params* instance, char* val) {
			instance->model_filename = std::string(val);
	}
	...
	void cv_face_FacemarkLBF_Params_propSave_model_bool(cv::face::FacemarkLBF::Params* instance, bool val) {
			instance->save_model = val;
	}
	...
	void cv_face_FacemarkLBF_Params_propSeed_unsigned_int(cv::face::FacemarkLBF::Params* instance, unsigned int val) {
			instance->seed = val;
	}
	...
	void cv_face_FacemarkLBF_Params_propFeats_m_vectorLintG(cv::face::FacemarkLBF::Params* instance, std::vector<int>* val) {
	...
	void cv_face_FacemarkLBF_Params_propRadius_m_vectorLdoubleG(cv::face::FacemarkLBF::Params* instance, std::vector<double>* val) {
	...
	void cv_face_FacemarkLBF_Params_propDetectROI_Rect(cv::face::FacemarkLBF::Params* instance, cv::Rect* val) {
