...
extern "C" {
	...
	void cv_ml_DTrees_Node_propValue_double(cv::ml::DTrees::Node* instance, double val) {
			instance->value = val;
	}
	...
	void cv_ml_DTrees_Node_propClassIdx_int(cv::ml::DTrees::Node* instance, int val) {
	...
	void cv_ml_DTrees_Node_propParent_int(cv::ml::DTrees::Node* instance, int val) {
			instance->parent = val;
	}
	...
	void cv_ml_DTrees_Node_propLeft_int(cv::ml::DTrees::Node* instance, int val) {
			instance->left = val;
	}
	...
	void cv_ml_DTrees_Node_propRight_int(cv::ml::DTrees::Node* instance, int val) {
			instance->right = val;
	}
	...
	void cv_ml_DTrees_Node_propDefaultDir_int(cv::ml::DTrees::Node* instance, int val) {
	...
	void cv_ml_DTrees_Node_propSplit_int(cv::ml::DTrees::Node* instance, int val) {
			instance->split = val;
	}
	...
	void cv_ml_DTrees_Split_propVarIdx_int(cv::ml::DTrees::Split* instance, int val) {
			instance->varIdx = val;
	}
	...
	void cv_ml_DTrees_Split_propInversed_bool(cv::ml::DTrees::Split* instance, bool val) {
	...
	void cv_ml_DTrees_Split_propQuality_float(cv::ml::DTrees::Split* instance, float val) {
	...
	void cv_ml_DTrees_Split_propNext_int(cv::ml::DTrees::Split* instance, int val) {
			instance->next = val;
	}
	...
	void cv_ml_DTrees_Split_propC_float(cv::ml::DTrees::Split* instance, float val) {
			instance->c = val;
	}
	...
	void cv_ml_DTrees_Split_propSubsetOfs_int(cv::ml::DTrees::Split* instance, int val) {
	...
	void cv_ml_ParamGrid_propMinVal_double(cv::ml::ParamGrid* instance, double val) {
			instance->minVal = val;
	}
	...
	void cv_ml_ParamGrid_propMaxVal_double(cv::ml::ParamGrid* instance, double val) {
			instance->maxVal = val;
	}
	...
	void cv_ml_ParamGrid_propLogStep_double(cv::ml::ParamGrid* instance, double val) {
