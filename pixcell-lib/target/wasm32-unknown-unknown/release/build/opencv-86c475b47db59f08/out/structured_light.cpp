...
extern "C" {
	...
	void cv_structured_light_GrayCodePattern_Params_propWidth_int(cv::structured_light::GrayCodePattern::Params* instance, int val) {
			instance->width = val;
	}
	...
	void cv_structured_light_GrayCodePattern_Params_propHeight_int(cv::structured_light::GrayCodePattern::Params* instance, int val) {
			instance->height = val;
	}
	...
	void cv_structured_light_SinusoidalPattern_Params_propWidth_int(cv::structured_light::SinusoidalPattern::Params* instance, int val) {
			instance->width = val;
	}
	...
	void cv_structured_light_SinusoidalPattern_Params_propHeight_int(cv::structured_light::SinusoidalPattern::Params* instance, int val) {
			instance->height = val;
	}
	...
	void cv_structured_light_SinusoidalPattern_Params_propNbrOfPeriods_int(cv::structured_light::SinusoidalPattern::Params* instance, int val) {
	...
	void cv_structured_light_SinusoidalPattern_Params_propShiftValue_float(cv::structured_light::SinusoidalPattern::Params* instance, float val) {
	...
	void cv_structured_light_SinusoidalPattern_Params_propMethodId_int(cv::structured_light::SinusoidalPattern::Params* instance, int val) {
	...
	void cv_structured_light_SinusoidalPattern_Params_propNbrOfPixelsBetweenMarkers_int(cv::structured_light::SinusoidalPattern::Params* instance, int val) {
	...
	void cv_structured_light_SinusoidalPattern_Params_propHorizontal_bool(cv::structured_light::SinusoidalPattern::Params* instance, bool val) {
	...
	void cv_structured_light_SinusoidalPattern_Params_propSetMarkers_bool(cv::structured_light::SinusoidalPattern::Params* instance, bool val) {
	...
	void cv_structured_light_SinusoidalPattern_Params_propMarkersLocation_vectorLPoint2fG(cv::structured_light::SinusoidalPattern::Params* instance, std::vector<cv::Point2f>* val) {
