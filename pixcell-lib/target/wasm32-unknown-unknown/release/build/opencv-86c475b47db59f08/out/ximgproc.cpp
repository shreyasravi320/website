...
extern "C" {
	...
	void cv_ximgproc_createScanSegment_int_int_int_int_bool(int image_width, int image_height, int num_superpixels, int slices, bool merge_small, Result<cv::Ptr<cv::ximgproc::ScanSegment>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::ximgproc::ScanSegment>*>, ocvrs_return);
	}
	...
	void cv_ximgproc_findEllipses_const__InputArrayR_const__OutputArrayR_float_float_float(const cv::_InputArray* image, const cv::_OutputArray* ellipses, float scoreThreshold, float reliabilityThreshold, float centerDistanceThreshold, Result_void* ocvrs_return) {
		try {
	...
	void cv_ximgproc_EdgeDrawing_propParams_Params(cv::ximgproc::EdgeDrawing* instance, cv::ximgproc::EdgeDrawing::Params* val) {
			instance->params = *val;
	}
