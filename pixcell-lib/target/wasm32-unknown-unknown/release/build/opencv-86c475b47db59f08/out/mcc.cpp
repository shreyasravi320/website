...
extern "C" {
	...
	void cv_mcc_DetectorParameters_propAdaptiveThreshWinSizeMin_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propAdaptiveThreshWinSizeMax_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propAdaptiveThreshWinSizeStep_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propAdaptiveThreshConstant_double(cv::mcc::DetectorParameters* instance, double val) {
	...
	void cv_mcc_DetectorParameters_propMinContoursAreaRate_double(cv::mcc::DetectorParameters* instance, double val) {
	...
	void cv_mcc_DetectorParameters_propMinContoursArea_double(cv::mcc::DetectorParameters* instance, double val) {
	...
	void cv_mcc_DetectorParameters_propConfidenceThreshold_double(cv::mcc::DetectorParameters* instance, double val) {
	...
	void cv_mcc_DetectorParameters_propMinContourSolidity_double(cv::mcc::DetectorParameters* instance, double val) {
	...
	void cv_mcc_DetectorParameters_propFindCandidatesApproxPolyDPEpsMultiplier_double(cv::mcc::DetectorParameters* instance, double val) {
	...
	void cv_mcc_DetectorParameters_propBorderWidth_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propB0factor_float(cv::mcc::DetectorParameters* instance, float val) {
	...
	void cv_mcc_DetectorParameters_propMaxError_float(cv::mcc::DetectorParameters* instance, float val) {
	...
	void cv_mcc_DetectorParameters_propMinContourPointsAllowed_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propMinContourLengthAllowed_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propMinInterContourDistance_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propMinInterCheckerDistance_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propMinImageSize_int(cv::mcc::DetectorParameters* instance, int val) {
	...
	void cv_mcc_DetectorParameters_propMinGroupSize_unsigned_int(cv::mcc::DetectorParameters* instance, unsigned int val) {
